...
class BertForDebiasSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        super(BertForDebiasSequenceClassification, self).__init__(config)
    ...
    def forward(self, setting, if_bias=False, **kwargs):
        ...
        outputs = self.bert(input_ids=kwargs['text_idx'].to(setting.device), 
